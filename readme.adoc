...
**Note**: The managed hub's `local-cluster` is disabled when the managed hub is imported to the global hub in default mode.
...
- link:kustomize-deployments/[Kustomize Deployments]
- link:rhacm-policies/[RHACM Policies (policy generator)]
